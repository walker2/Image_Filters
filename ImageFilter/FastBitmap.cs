...
namespace ImageFilter
{
    ...
    public struct Color32 : IEquatable<Color32>
    {
        ...
        public Color Color
        {
            get { return Color.FromArgb(this.R, this.G, this.B); }
        }
        ...
        {
            return this.R.Equals(other.R) && G.Equals(other.G) && B.Equals(other.B);
        }
    ...
    public unsafe class FastBitmap : IDisposable
    {
        ...
        /// </returns>
        public Color32* this[int x, int y] => (Color32*) (this.pixelBase + (y * this.bytesInARow) + x * 3);
        ...
        public long GetSumT(int x, int y, int rectangleWidth, int rectangleHeight)
        {
            ...
            int d = (this.tiltedWidth * (y + rectangleWidth + rectangleHeight)) +
                    (x + rectangleWidth - rectangleHeight + 1);
